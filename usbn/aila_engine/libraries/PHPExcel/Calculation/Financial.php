...
class PHPExcel_Calculation_Financial {
	 ...
	 * the calculation depending on the life of the aila_cbt.
	 * This function will return the depreciation until the last period of the life of the aila_cbt
	 * or until the cumulated value of depreciation is greater than the cost of the aila_cbt minus
	 * the salvage value.
	 *
	 * Excel Function:
	...
	public static function AMORDEGRC($cost, $purchased, $firstPeriod, $salvage, $period, $rate, $basis=0) {
		...
		//	Life of aila_cbt (1/rate)		Depreciation coefficient
		//	Less than 3 years			1

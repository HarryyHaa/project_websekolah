	...
	<div class="col m12 s12">
		<div class="card">
			<div class="card-content">
				...
				<p>Disini anda bisa melihat arsip soal dan mengkatifkannya kembali. Fitur hapus belum tersedia karena paket soal ini berkaitan dengan kelas ujian dan jawaban ujian siswa.</p>
			</div>
		</div>
	</div>
</div>
					...
					<tbody>
						<?php $no=1; foreach ($quiz as $row) { ?>
							<tr>
								...
								<td>
									<a onclick="return confirm('Apakah mau mengaktifkan paket soal ini beserta seluruh pertanyaannya?');" href="<?php echo site_url('admin/quiz/make_active/'.encode($row->ID));?>" class="btn-small green">Aktifkan</a>

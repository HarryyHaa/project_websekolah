	...
	<div class="col m12 s12">
		<div class="card">
			<div class="card-content center">
				...
				<?php } ?>
				<a  onclick="return confirm('Apakah anda yakin ingin menggenerate ulang kode kelas?')"  title="Genrate Ulang" class="btn btn-floating green" href="<?=site_url('teacher/classroom/regenerate_code/'.encode($classroom->ID));?>"><i class="material-icons">autorenew</i></a></span></h1>
				<hr/>
				...
				<p>Paket soal dalam kelas ini 
					<?php if ($classroom->working_status == 0) {
						echo "<b>masih tertutup</b> sehingga Siswa/Siswi <b>belum bisa</b> mengerjakannya <br/><br/> <a onclick='return confirm(\"Apakah yakin waktu pengerjaan soal mau dimulai?\")' href='".site_url('teacher/classroom/start/'.strtoupper($classroom->code))."' class='btn green'>Mulai Waktu Pengerjaan</a>";
					}elseif($classroom->working_status == 1){
						echo "waktu pengerjaannya <b>sedang berlangsung</b>, seluruh Siswa/Siswi yang telah masuk ke kelas ini bisa mengerjakan soal. <br/><br/> <a onclick='return confirm(\"Apakah yakin waktu pengerjaan soal mau dihentikan?\")' href='".site_url('teacher/classroom/stop/'.strtoupper($classroom->code))."' class='btn red'>Hentikan Waktu Pengerjaan</a>";
					}else{
						echo "sudah tidak bisa dikerjakan oleh Siswa/Siswi karena waktu pengerjaannya sudah selesai.<br/><br/> <a onclick='return confirm(\"Apakah yakin waktu pengerjaan soal mau dimulai kembali?\")' href='".site_url('teacher/classroom/start/'.strtoupper($classroom->code))."' class='btn blue'>Mulai Kembali</a>";
					}?>
				</p>
			</div>
		</div>

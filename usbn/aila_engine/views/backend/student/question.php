...
<style type="text/css">
	...
	.header-quiz{
		background: url(<?=base_url('aila_cbt/images/');?>header-bg.png) no-repeat;
	...
	<div class="navbar">
		<nav class="header-quiz" role="navigation">
			<div class="nav-wrapper">
				<a href="#" class="brand-logo"><img src="<?=base_url('aila_cbt/images/logo-cbt.png');?>"></a>
				<div>
					
					<ul class="right hide-on-med-and-down right-account collection">
						<li class="collection-item avatar">
							<img style="float: right;" src="<?php echo base_url('');?>aila_cbt/images/avatar.png">
					...
					<div class="card-content">
						...
						<div class="row">
							...
							<div class="col m12 s12" id="audio">
								...
								<?php if (($quiz->audio != NULL) AND ($quiz->audio != '')) {  if (file_exists(('aila_cbt/audio/'.$quiz->quiz_name_ID.'/'.$quiz->audio))) { ?>

									<audio id='audio_core' controls controlsList='nodownload'>
										<source src="<?=base_url('aila_cbt/audio/'.$quiz->quiz_name_ID.'/'.$quiz->audio);?>" type="audio/mpeg">
										</audio>
		...
		<div class="row">
			<div class="col s12">
				...
				<div class="">
					...
					<a  class="modal-close waves-effect waves-white btn red">Batal</a>
				</div>
			</div>
		</div>
		<?php echo form_close();?>
...
<script src = "<?=base_url('aila_cbt/js/');?>jquery-1.10.2.min.js"
	...
	<script src="<?=base_url('aila_cbt/js/aila_cbt.js');?>"></script>	


	<script type="text/javascript" async src="<?=base_url('aila_cbt/vendor/tinymce');?>/plugins/tiny_mce_wiris/integration/WIRISplugins.js?viewer=image"></script>

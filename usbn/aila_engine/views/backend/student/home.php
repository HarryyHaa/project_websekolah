		...
		<div class="card hoverable">
			<div class="card-content">
				...
				<table class="table">
					...
					<tbody>
						<?php $no=1; foreach ($available_classroom as $available) { ?>
							<tr>
								<td class="hide-on-med-and-down"><?=$no;?></td>
								<!--<td><?php echo $available->code;?></td>-->
								<td><?php echo $available->name;?></td>
								<!--<td><a href="<?=site_url('student/classroom/join_available/'.$available->code);?>" class="btn-small blue btn-floating"><i class="material-icons">arrow_forward</i></a></td>-->
							</tr>
							<?php $no++; }?>
						</tbody>
					</table>

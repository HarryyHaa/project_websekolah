		...
		<div class="card">
			<div class="card-content">
				...
				<div class="row">
					...
					<div class="input-field col m6 s12">
						<select  name="student_group" class="select2">
						...
						<span class="green-text"><i>*Biarkan kosong jika ingin membagikan kode kelas kepada <?=$this->config->item('student');?> trtentu saja</i></span>
					</div>
				</div>

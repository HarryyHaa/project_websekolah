...
<head>
	...
	<body onload="window.print()">
		...
		<div class="row" style="margin-top: 20px;">
			<table>
				<tr>
					<td width="80"><img src="<?=base_url('stephan_cbt/images/logo.png');?>" width="60" style="margin-left: 10px;"></td>
					<td>
						<center>
			...
			<h4 style="margin: 0px 0px 5px 0px; text-align: center; padding-top: 10px;">Absen <?=strtoupper($this->config->item('student'));?></h4>
			<table width="100%">

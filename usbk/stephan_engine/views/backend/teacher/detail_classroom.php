				...
				<div class="card-content">
					<h5> <center>Nilai <?=$this->config->item('student');?></center> <br/>
						<center>
							...
							<a href="<?=site_url('teacher/classroom/check_code/'.strtoupper($classroom->code));?>" class="btn-small green" title="Daftar Hadir">Daftar Hadir<i class="material-icons right">list</i></a>

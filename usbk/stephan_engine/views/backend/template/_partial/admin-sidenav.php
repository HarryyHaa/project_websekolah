...
<ul class="sidenav sidenav-fixed side-nav" id="slide-out">
	<li class="sidenav-header blue hide-on-med-and-up">
		<div class="row avatar">
			<div class="col s4">
				<img src="<?=base_url('stephan_cbt/images/logo.png');?>" width="55px" height="55px" alt="" class="circle responsive-img valign profile-image">
			</div>
			<div class="col s8">
	...
	<li class='white'><a class="waces-effect" href="<?php echo site_url('admin/teacher');?>"><?=$this->config->item('teacher');?> <i class="material-icons left">people</i> </a></li>
	<li class='white'><a class="waces-effect" href="<?php echo site_url('admin/student');?>"><?=$this->config->item('student');?> <i class="material-icons left">people</i> </a></li>
	...
	<li class='white'><a class="waces-effect" href="<?php echo site_url('admin/home/school_profile');?>">Profil <?=$this->config->item('school');?> <i class="material-icons left">school</i> </a></li>
	<li class="white">
		<ul class="collapsible collapsible-accordion">
			<li>
				...
				<div class="collapsible-body">
					<ul>
						<li><a class="waves-effect waves-blue" href="<?php echo site_url('admin/student/archive');?>"><i class="material-icons">people</i><?=$this->config->item('student');?></a></li>
						<li><a class="waves-effect waves-blue" href="<?php echo site_url('admin/teacher/archive');?>"><i class="material-icons">people</i><?=$this->config->item('teacher');?></a></li>
	...
	<li class='white'><a class="waces-effect" href="<?php echo site_url('admin/student_card');?>">Cetak Kartu<i class="material-icons left">folder_open</i> </a></li>
	
	<!--<li class='white'><a class="waces-effect" href="<?php echo site_url('backend/admin/list_student');?>">Cetak Kartu<i class="material-icons left">folder_open</i> </a></li>-->

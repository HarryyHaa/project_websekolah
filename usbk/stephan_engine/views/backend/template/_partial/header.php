...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo base_url('') ;?>stephan_cbt/css/select2-materialize.css">

	<!-- Datatables -->
	<link rel="stylesheet" type="text/css" href="<?php echo base_url('') ;?>stephan_cbt/css/dataTables.material.min.css">
	...
	<?php if ($this->uri->segment(1) != 'student') { ?>
		...
		<script src="<?=base_url('stephan_cbt/vendor/tinymce');?>/plugins/tiny_mce_wiris/integration/WIRISplugins.js?viewer=image"></script>
		<script src="<?=base_url('stephan_cbt/vendor/tinymce');?>/tinymce.min.js"></script>
	...
	<title>Halaman 
		...
		switch ($this->uri->segment(1)) {
			...
			case 'teacher':
			echo $this->config->item('teacher');
			break;

			case 'student':
			echo $this->config->item('student');
			break;
		...
		?> - <?=strip_tags($this->config->item('cbt_name'));?> | Lolipop </title>

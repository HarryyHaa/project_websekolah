	...
	<div class="col m12 s12">
		<div class="card">
			<div class="card-content center">
				...
				<p>Ganti dulu ya passwordnya <?php echo $this->session->userdata('name');?>, biar akunnya tetap aman.. ^^<br/>Gunakan password yang susah ditebak dan minimal jumlahnya 8 digit.</p>
			</div>
		</div>
	</div>
</div>
			...
			<div class="card-content">
				...
				<div class="row">
					...
					<div class="input-field col m6 s12">
						<input type="password" name="new_password" id="new_password" autocomplete="off"  aria-required="true" data-error="wrong" data-success="right" required="" autofocus="">

		...
		<div class="col m12 s12">
			<div class="card">
				<div class="card-content">
					<h5 class="center">Panduan Manajemen Print Card <?=$this->config->item('student');?> </h5>
					<ul>
...
<div class="row">
	...
	<?php };?>
				...
				?>
				<h5>Cetak kartu ujian <?=$this->config->item('student');?> 
					<a href="#filter_group" class="btn-small green modal-trigger">Filter berdasarkan kelas <i class="material-icons right" title="Filter Jurusan">filter_list</i></a>

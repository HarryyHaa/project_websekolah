					...
					<div class="card-body">
						<div class="row">
							...
							<div class="col s8 right right-menu">
								<span class="number" id="totalTeacher">0</span>
								<br/>
								<span> <?=strtoupper($this->config->item('teacher'));?></span>
							</div>
						</div>
					</div>
				...
				<div class="card gradient-45deg-red-pink white-text">
					<div class="card-body">
						<div class="row">
							...
							<div class="col s8 right right-menu">
								<span class="number" id="totalStudent">0</span>
								<br/>
								<span> <?=strtoupper($this->config->item('student'));?></span>
							</div>
						</div>
					</div>
					<div class="card-action" style="">
				...
				<div class="card gradient-45deg-amber-amber white-text ">
					<div class="card-body">
						<div class="row">
							...
							<div class="col s8 right right-menu">
								<span class="number" id="totalQuizName">0</span>
								<br/>
								<span> BANK SOAL</span>
							</div>
						</div>
				...
				<div class="card gradient-45deg-green-teal white-text">
					<div class="card-body">
						<div class="row">
							...
							<div class="col s8 right right-menu">
								<span class="number" id="totalClassroom"> 0</span>
								<br/>

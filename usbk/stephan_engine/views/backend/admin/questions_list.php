	...
	<div class="col m12 s12">
		<div class="card">
			<div class="card-content">
				...
				<h5>Daftar Soal Ujian <a href="<?php echo site_url('admin/quiz/create_quiz/'.$ID);?>" class="btn-small green">Tambah <i class="material-icons right" title="Tambah baru">add</i></a>

					<a href="#quiz_import" class="btn-small green modal-trigger" title="Upload Banyak">Import <i class="material-icons right">add</i><i class="material-icons right">add</i></a> 

...
<body class="host_version"> 
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbars-host">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item"><a class="nav-link" href="program_sekolah.html">Program Sekolah</a></li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="dropdown-a" data-toggle="dropdown">Program Keahlian</a>
                            <div class="dropdown-menu" aria-labelledby="dropdown-a">
                                <a class="dropdown-item" href="tkj.html">Teknik Komputer & Jaringan </a>
                                <a class="dropdown-item" href="akuntansi.html">Akuntansi & Keuangan Lembaga</a>
                            </div>
                        </li>
                        <!--<li class="nav-item dropdown">
                        ...
                        <li class="nav-item"><a class="nav-link" href="sarana.html">Sarana & Pra sarana</a></li>
                        ...
                        <li class="nav-item"><a class="nav-link" href="pricing.html">e-Learning</a></li>
                        <li class="nav-item"><a class="nav-link" href="pricing.html">PPDB</a></li>
    ...
    <div class="all-title-box">
        <div class="container text-center">
            <h1>Agenda-Kegiatan-Artikel<span class="m_1">SMK Plus Pratama Adi</span></h1>
        </div>
    </div>

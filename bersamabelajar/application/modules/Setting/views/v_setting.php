...
<div class="card-body">
    <form enctype="multipart/form-data" id="fupForm">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" name="kabupaten" value="<?= $setting['kota'] ?>">
            </div>
        </div>
        <div class="form-group row">
            <label for="kepsek" class="col-sm-2 col-form-label">Kepala Sekolah</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" name="kepsek" id="kepsek" value="<?= $setting['kepsek'] ?>">
            </div>
        </div>
        <div class="form-group row">
            <label for="nipkepsek" class="col-sm-2 col-form-label">NIP Kepala Sekolah</label>
            <div class="col-sm-10">
        ...
        <div class="form-group row">
            <label for="bottoken" class="col-sm-2 col-form-label">Website</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" name="web" id="web" value="<?= $setting['web'] ?>">
            </div>
        </div>
        <div class="form-group row">
            <label for="bottoken" class="col-sm-2 col-form-label">Email</label>
            <div class="col-sm-10">
                <input type="email" class="form-control" name="email" id="email" value="<?= $setting['email'] ?>">
            </div>
        </div>
        <div class="form-group row">
            <label for="bottoken" class="col-sm-2 col-form-label">No Telp</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" name="telp" id="telp" value="<?= $setting['telp'] ?>">
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-3">
                <div class="custom-file">
                    <input type="file" class="custom-file-input" name='file2' id="inputGroupFile01">
                    <label class="custom-file-label" for="inputGroupFile01">Choose file</label>
                </div>
            </div>
        </div>
